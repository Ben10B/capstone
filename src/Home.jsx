...
class Dashboard extends Component {
    hover = () => { document.getElementById('headerImg').style.backgroundImage = `url(${powerUpF})`; };
    leave = () => { document.getElementById('headerImg').style.backgroundImage = `url(${idleF})`; };
    zoomIn = () => { document.getElementById('headerImg').style.backgroundSize = `contain`; };
    zoomOut = () => { document.getElementById('headerImg').style.backgroundSize = `auto`; };
    render() {
        return (
            <div id="dashboard" className="row">
                <div id="headerImg" className="flex-1" style={{ backgroundImage: `url(${idleF})` }}
...
const GoalDetail = ({nameOfGoal, clickFunction}) => {
    return (
      <div className="goal fnt-white">
        <div>
            <p onClick={()=>clickFunction(nameOfGoal)}>Goal {nameOfGoal} </p>
